...
mod tests {
    ...
    fn test_battle_creation() {
        ...
        let player_rules: Vec<RuleNode> = vec![Box::new(combat_engine::StrikeActionNode)];
        let enemy_rules: Vec<RuleNode> = vec![Box::new(combat_engine::StrikeActionNode)];
...
mod integration_tests {
    ...
    fn test_action_system_integration_with_battle() {
        ...
        let player_rules: Vec<RuleNode> = vec![
            Box::new(combat_engine::ConditionCheckNode::new(
                Box::new(combat_engine::RandomConditionNode),
                Box::new(combat_engine::HealActionNode),
            )),
            Box::new(combat_engine::StrikeActionNode),
        ];
        let enemy_rules: Vec<RuleNode> = vec![Box::new(combat_engine::StrikeActionNode)];
        let rng = create_test_rng();
        let mut battle = Battle::new(player, enemy, player_rules, enemy_rules, rng);
        ...
        for _ in 0..10 {
            ...
            let mut battle_test = Battle::new(player_test, enemy_test, vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng_test);
    ...
    fn test_complete_battle_simulation() {
        ...
        let rng = create_test_rng();
        let mut battle = Battle::new(player, enemy, vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng);
    ...
    fn test_battle_victory_conditions() {
        ...
        let rng = create_test_rng();
        let mut battle = Battle::new(player, weak_enemy, vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng);
        let rng = create_test_rng();
    ...
    fn test_battle_with_mp_depletion() {
        ...
        let rng = create_test_rng();
        let mut battle = Battle::new(low_mp_player, enemy, vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng);
    ...
    fn test_aggressive_vs_defensive_strategies() {
        ...
        let mut aggressive_battle = Battle::new(player.clone(), enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng3);
        aggressive_battle.player_action_system = aggressive_system;
        let mut defensive_battle = Battle::new(player.clone(), enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng4);
    ...
    fn test_hp_based_healing_logic() {
        ...
        let rng1 = create_test_rng();
        let mut low_hp_battle = Battle::new(low_hp_character, enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng1);
        let rng2 = create_test_rng();
        ...
        let rng3 = create_test_rng();
        let mut high_hp_battle = Battle::new(high_hp_character, enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng3);
        let rng4 = create_test_rng();
    ...
    fn test_hp_threshold_boundary_conditions() {
        ...
        let rng = create_test_rng();
        let mut battle = Battle::new(exactly_50_hp_character, enemy, vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng);
        let rng = create_test_rng();
    ...
    fn test_conditional_healing_strategy() {
        ...
        let rng3 = create_test_rng();
        let mut low_hp_battle = Battle::new(low_hp_player, enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng3);
        let rng1 = create_test_rng();
        low_hp_battle.player_action_system = ActionCalculationSystem::new(create_conditional_rules(), rng1);
        
        let rng4 = create_test_rng();
        let mut high_hp_battle = Battle::new(high_hp_player, enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng4);
        let rng2 = create_test_rng();
    ...
    fn test_deterministic_rule_execution() {
        ...
        let rng3 = create_test_rng();
        let mut battle1 = Battle::new(player.clone(), enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng3);
        let rng1 = create_test_rng();
        battle1.player_action_system = ActionCalculationSystem::new(create_deterministic_rules(), rng1);
        
        let rng4 = create_test_rng();
        let mut battle2 = Battle::new(player.clone(), enemy.clone(), vec![Box::new(combat_engine::StrikeActionNode)], vec![Box::new(combat_engine::StrikeActionNode)], rng4);
        let rng2 = create_test_rng();
